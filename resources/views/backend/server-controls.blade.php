        ...
        <div class="column is-half">
            <div class="column is-half">
                <div class="block">
                    ...
                    <p>
                        Updates the count of comments per Cases. (useful in case a spammer screws with us)
                    </p>
                </div>
...
<section class="section container">
    <div class="columns is-multiline is-mobile">
        <div class="column is-half">
            <div class="block">
                <h1 class="title">
                    Root removal warnings
                </h1>

                <p>
                    Sends "ChannelRemovalWarning" email to inactive roots' moderators.
                </p>
            </div>
