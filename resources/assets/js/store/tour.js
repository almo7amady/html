export default {
    ...
    items: [
        ...
        },
        {
            id: 'feed',
            title: 'Feed:',
            body: `<p>Your feed/homepage is your best friend on Case Root. It is where you find all the cool stuff posted to Case Root.</p>
        ...
        },
        {
            ...
            body: `<p>Last but not least, click on "Allow" to turn on web push notifications for Case Root to receive notifications in your OS when Case Root is not the active tab in your browser. (like when you have minimized the browser to watch Game of Thrones!)</p>
            <p><strong>Note:</strong> Unlike other websites, we do not bother you. We only send push notifications when Case Root is present in your browser.  </p>`
        }
    ]
};
