<template>
	<el-dialog title="Customize Feed"
		...
		<section class="user-select">
			<p>
				Other than subscribing to Roots, there are more filters available to make sure you get the content that suits you the best.
			</p>
...
export default {
    ...
    data() {
        return {
            ...
            filters: [
                { value: 'all', description: 'Cases from all Roots' },
                {
                    value: 'subscribed',
                    description: 'Only Cases from Roots I am subscribed to'
                },
                {
                    value: 'moderating',
                    description: 'Only Cases from Roots I am moderating'
                },
                {
                    value: 'bookmarked',
                    description: 'Only Cases from Roots I have bookmarked'
                },
                {
                    value: 'by-bookmarked-users',
                    description: 'Only Cases from users I have bookmarked'
                }
            ]
        };
    },
