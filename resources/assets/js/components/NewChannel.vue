		...
		<el-form label-position="top"
			...
			<el-form-item label="Description">
				<el-input type="textarea"
				          placeholder="A few word to describe your root..."
				          name="description"
...
export default {
    ...
    data() {
        return {
            ...
            customError: '',
            loading: false,
            warning: `At the current stage, we're trying to keep the Root number short, making it easier for new users. Thus, please do a little search before creating your channel to make sure a similar one doesn't already exist. `
        };
    },
