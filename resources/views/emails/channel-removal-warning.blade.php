...
# Dear {{ '@' . $user->username }}, moderator of [#{{ $channel->name }}](https://www.caseroot.com/r/{{ $channel->name }}?ref=email)
...
@component('mail::button', ['url' => config('app.url') . '/r/' . $channel->name . '?ref=email'])
    Go to #{{ $channel->name }}
@endcomponent
...
@component('mail::subcopy')
    Need help? ask [community](https://www.caseroot.com/r/Community), or hit us up on Twitter [@case_root](https://twitter.com/elmo7amady).
