<template>
    ...
    >
        <p>
            Case Root uses a slightly-customized and limited version of Markdown for formatting. Here is a quick and simple guide:
        </p>
        ...
        <table class="table enable-user-select">
            ...
            <tr>
                <td>
                    [caseroot.com](https://www.caseroot.com)
                </td>

                <td>
                    <a href="https://www.caseroot.com" target="_blank">caseroot.com</a>
                </td>
            </tr>
