            ...
            <div class="column">
                ...
                {{--<div class="content">--}}
                    {{--@if($user->rules()->count())--}}
                        ...
                        {{--</ol>--}}
                    {{--@else--}}
                        {{--This Root has no exclusive rules.--}}
                    {{--@endif--}}
                {{--</div>--}}
                ...
                <div class="flex-space">
                    <p>
                        Ban <a href="/{{ '@' . $user->username }}" target="_blank">{{ '@' . $user->username }}</a> from submitting Cases or/and comments to entire application.
                    </p>
                ...
                {{--@if($isAdministrator)--}}
                    {{--<i class="field">--}}
                        {{--You're already an administrator of this root.--}}
                    {{--</i>--}}
                {{--@else--}}
                    {{--<p class="field">--}}
                        {{--This'll make you an administrator of the root so you can take necessary actions.--}}
                    {{--</p>--}}
