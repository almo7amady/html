<template>
    <section class="home-wrapper" v-once>
        ...
        <section id="page" class="home-submissions credits">
            <p>
                Case Root would like to thank the authors of the following open source components and third party services that contributed essential functionality to our applications:
            </p>
            ...
            <div class="container-grid margin-top-2">
                ...
                <div class="item">
                    ...
                    <div>
                        <p>
                            Vue is a progressive framework for building user interfaces. Vue's bleeding fast performance is the main reason Case Root's developer picked it as our primary JS framework.
                        </p>
                ...
                <div class="item">
                    <h3>
                        <a href="https://voten.co/" rel="nofollow">
                            <img src="/landing/credits/voten.png" alt="PHP7">
                        </a>
                    </h3>
