    ...
    >
        <div class="user-select">
            <el-form label-position="top" label-width="10px" :model="form">
                <el-form-item label="Limit Root results to:">
                    <el-input-number v-model="form.channelsLimit" :step="1" :min="2" :max="500"></el-input-number>
                </el-form-item>

                <el-form-item label="Filter Roots by...">
                    <el-select v-model="form.channelsFilter" placeholder="Filter Roots by..." filterable>
    ...
    data() {
        return {
            ...
            filters: [
                {
                    value: 'subscribed',
                    description: 'Roots I have subscribed to'
                },
                {
                    value: 'moderating',
                    description: 'Roots I am moderating'
                },
                {
                    value: 'bookmarked',
                    description: 'Roots I have bookmarked'
                }
            ],
