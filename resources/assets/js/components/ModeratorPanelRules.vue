<template>
    <section id="moderator-panel-rules">
        ...
        <p>
            If your channel needs more rules than already written in Case Root's general <a href="/tos">TOS</a>
            page, you may specify yours here.
            To keep Case Root simple, we allow a maximum number of fine rules per channel. Markdown syntax is allowed.
        </p>
