		...
		<aside class="menu"
			...
			<div class="no-subscription"
				...
				<i class="v-icon v-channel"
				   aria-hidden="true"></i> No Roots to display
			</div>
...
export default {
    ...
    computed: {
        ...
        filterForHumans() {
            if (this.filter == 'subscribed') return 'Subscribed Roots';

            if (this.filter == 'bookmarked') return 'Bookmarked Roots';

            if (this.filter == 'moderating') return 'Moderating Roots';
        },
